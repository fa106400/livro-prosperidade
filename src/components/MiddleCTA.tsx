      ...
      <div className="w-full flex-1 px-4 py-6">
        ...
        <div className="flex w-full items-stretch text-[rgba(18,23,20,1)] font-bold leading-none justify-center flex-1 h-full mt-3.5">
          <div className="flex min-w-60 w-[357px] flex-col items-center justify-center">
            <button className="bg-[rgba(20,226,90,1)] shadow-[2px_4px_4px_rgba(0,0,0,0.25)] flex min-w-[84px] min-h-[52px] w-[280px] max-w-full items-center overflow-hidden justify-center px-4 rounded-[100px] hover:bg-[rgba(18,203,81,1)] transition-colors">
